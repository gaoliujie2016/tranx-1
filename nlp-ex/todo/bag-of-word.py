...
# It is a model that tries to predict words given the context of a few words before and
# a few words after the target word. This is distinct from language modeling,
